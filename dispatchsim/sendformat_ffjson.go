...
// MarshalJSON marshal bytes to json - template
func (j *StatsDriverStatusFormat) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *StatsDriverStatusFormat) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffjtStatsDriverStatusFormatbase = iota
	ffjtStatsDriverStatusFormatnosuchkey

	ffjtStatsDriverStatusFormatTime

	ffjtStatsDriverStatusFormatRoamingDrivers

	ffjtStatsDriverStatusFormatFetchingDrivers

	ffjtStatsDriverStatusFormatTravellingDrivers
)

var ffjKeyStatsDriverStatusFormatTime = []byte("time")

var ffjKeyStatsDriverStatusFormatRoamingDrivers = []byte("no_of_roaming_drivers")

var ffjKeyStatsDriverStatusFormatFetchingDrivers = []byte("no_of_picking_up_drivers")

var ffjKeyStatsDriverStatusFormatTravellingDrivers = []byte("no_of_travelling_drivers")

// UnmarshalJSON umarshall json - template of ffjson
func (j *StatsDriverStatusFormat) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *StatsDriverStatusFormat) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtStatsDriverStatusFormatbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtStatsDriverStatusFormatnosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'n':
					...
					if bytes.Equal(ffjKeyStatsDriverStatusFormatRoamingDrivers, kn) {
						currentKey = ffjtStatsDriverStatusFormatRoamingDrivers
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyStatsDriverStatusFormatFetchingDrivers, kn) {
						currentKey = ffjtStatsDriverStatusFormatFetchingDrivers
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyStatsDriverStatusFormatTravellingDrivers, kn) {
						currentKey = ffjtStatsDriverStatusFormatTravellingDrivers
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeyStatsDriverStatusFormatTime, kn) {
						currentKey = ffjtStatsDriverStatusFormatTime
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyStatsDriverStatusFormatTravellingDrivers, kn) {
					currentKey = ffjtStatsDriverStatusFormatTravellingDrivers
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStatsDriverStatusFormatFetchingDrivers, kn) {
					currentKey = ffjtStatsDriverStatusFormatFetchingDrivers
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStatsDriverStatusFormatRoamingDrivers, kn) {
					currentKey = ffjtStatsDriverStatusFormatRoamingDrivers
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyStatsDriverStatusFormatTime, kn) {
					currentKey = ffjtStatsDriverStatusFormatTime
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtStatsDriverStatusFormatTime:
					goto handle_Time

				case ffjtStatsDriverStatusFormatRoamingDrivers:
					goto handle_RoamingDrivers

				case ffjtStatsDriverStatusFormatFetchingDrivers:
					goto handle_FetchingDrivers

				case ffjtStatsDriverStatusFormatTravellingDrivers:
					goto handle_TravellingDrivers

				case ffjtStatsDriverStatusFormatnosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
// MarshalJSON marshal bytes to json - template
func (j *StatsVirusFormat) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *StatsVirusFormat) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
	...
	buf.WriteString(`{"time":`)
	fflib.WriteJsonString(buf, string(j.Time))
	buf.WriteString(`,"tasks_to_drivers":`)
	fflib.FormatBits2(buf, uint64(j.TasksToDrivers), 10, j.TasksToDrivers < 0)
	buf.WriteString(`,"drivers_to_tasks":`)
	fflib.FormatBits2(buf, uint64(j.DriversToTasks), 10, j.DriversToTasks < 0)
	buf.WriteByte('}')
	return nil
}

const (
	ffjtStatsVirusFormatbase = iota
	ffjtStatsVirusFormatnosuchkey

	ffjtStatsVirusFormatTime

	ffjtStatsVirusFormatTasksToDrivers

	ffjtStatsVirusFormatDriversToTasks
)

var ffjKeyStatsVirusFormatTime = []byte("time")

var ffjKeyStatsVirusFormatTasksToDrivers = []byte("tasks_to_drivers")

var ffjKeyStatsVirusFormatDriversToTasks = []byte("drivers_to_tasks")

// UnmarshalJSON umarshall json - template of ffjson
func (j *StatsVirusFormat) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *StatsVirusFormat) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtStatsVirusFormatbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtStatsVirusFormatnosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'd':
					...
					if bytes.Equal(ffjKeyStatsVirusFormatDriversToTasks, kn) {
						currentKey = ffjtStatsVirusFormatDriversToTasks
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeyStatsVirusFormatTime, kn) {
						currentKey = ffjtStatsVirusFormatTime
						state = fflib.FFParse_want_colon
						goto mainparse

					} else if bytes.Equal(ffjKeyStatsVirusFormatTasksToDrivers, kn) {
						currentKey = ffjtStatsVirusFormatTasksToDrivers
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyStatsVirusFormatDriversToTasks, kn) {
					currentKey = ffjtStatsVirusFormatDriversToTasks
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyStatsVirusFormatTasksToDrivers, kn) {
					currentKey = ffjtStatsVirusFormatTasksToDrivers
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyStatsVirusFormatTime, kn) {
					currentKey = ffjtStatsVirusFormatTime
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtStatsVirusFormatTime:
					goto handle_Time

				case ffjtStatsVirusFormatTasksToDrivers:
					goto handle_TasksToDrivers

				case ffjtStatsVirusFormatDriversToTasks:
					goto handle_DriversToTasks

				case ffjtStatsVirusFormatnosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
handle_TasksToDrivers:

	/* handler: j.TasksToDrivers type=int kind=int quoted=false*/
...
handle_DriversToTasks:

	/* handler: j.DriversToTasks type=int kind=int quoted=false*/
